...
Gem::Specification.new do |spec|
  ...
  spec.version       = BlockStack::UI::VERSION
  spec.authors       = ["Brandon Black"]
  spec.email         = ["d2sm10@hotmail.com"]

  spec.summary       = %q{Adds a UI layer to the BlockStack web server framework.}
  spec.description   = %q{The UI elements of the BlockStack web server framework.}
  spec.homepage      = "https://github.com/bblack16/block-stack-ui"
  spec.license       = "MIT"
